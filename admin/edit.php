...
if (isset($_POST['edit'])) {
  ...
  $sql = "UPDATE patient_record SET pr_fname = '$pr_fname', pr_lname = '$pr_lname', pr_mname = '$pr_mname', pr_contact_no = '$pr_contact_no', pr_guardians_no = '$pr_guardians_no', pr_grade = '$pr_grade', pr_section = '$pr_section', pr_strand = '$pr_strand', pr_gender = '$pr_gender', pr_province = '$pr_province', pr_city = '$pr_city', pr_barangay = '$pr_barangay', pr_addrs = '$pr_addrs', pr_bdate = '$pr_bdate', pr_age = '$age' WHERE pr_id = $ed_id ";
          ...
          <div class="addpatientform">
            ...
            <div class="patient-details">
              ...
              <div class="input-box">
                ...
                <input type="text" name="pr_mname" placeholder="Enter middlename" value="<?php echo $row['pr_mname'] ?>" required>
              </div>
              <div class="input-box">
            ...
            <div class="gender-details">
              <input type="radio" name="pr_gender" value="Male" id="dot-1"
                <?php echo ($row['pr_gender'] === 'Male') ? 'checked' : ''; ?>
              >
              <input type="radio" name="pr_gender" value="Female" id="dot-2"
              <?php echo ($row['pr_gender'] === 'Female') ? 'checked' : ''; ?>
              >
